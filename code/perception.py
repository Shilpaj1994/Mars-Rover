...
def color_thresh(img, rgb_thresh=(160, 160, 160), flag="drive"):
...
# Threshold to find the rocks
def rock_thresh(img, rgb_thresh=(180, 210, 80)):
    pixels = (img[:, :, 0] > rgb_thresh[0]) \
             & (img[:, :, 1] > rgb_thresh[1]) \
             & (img[:, :, 2] > rgb_thresh[2])
